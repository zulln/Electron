...
#include "sound/osVersionTest_mac.h"
#include "clipboard/Clearclipboard_mac.h"
...
void OnLockdown(const FunctionCallbackInfo<Value>& args) {
	...
	//Set kiosk, fullscreen mode


	bool finished = (MuteVolume() && Clearclipboard());

	args.GetReturnValue().Set(finished);
}
