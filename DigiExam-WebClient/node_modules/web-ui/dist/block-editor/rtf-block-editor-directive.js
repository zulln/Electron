(function iife() {
	...
	function rtfBlockEditorDirective(
		...
		function link($scope, $element) {
			...
			$scope.$watch("remainingWords", function watchRemainingWords(newVal) {
			...
			function hardWordlimitCallback() {
				...
				hardLimitTimeout = $timeout(function hardLimitTimeoutCallback() {
			...
			scribe.on("content-changed", function onContentChanged() {
		...
		function controller(
			...
			self.wordCountClassNames = function wordCountClassNames() {
				var classNames = [];
			...
			self.addContentFocus = function addContentFocus() {
				$scope.$element.addClass(CLASSNAME_FOCUS_MOD);
			};

			self.removeContentFocus = function removeContentFocus() {
				$scope.$element.removeClass(CLASSNAME_FOCUS_MOD);
			};

			self.getWordCountDisplay = function getWordCountDisplay(wordCount, question) {
		...
		controller.$inject = ["$scope", "CapSettingEnum"];
