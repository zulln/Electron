#ifndef CLEAR_CLIPBOARD_MAC_H
#define CLEAR_CLIPBOARD_MAC_H
...
namespace lockdown {
	class ClearClipboard : public BaseLockdownTask//: public BasePreConditionTest	<-- Needs to be modified, use abstract class that defines runTask(callback) and that has an isSuccess method
	{
	public:
