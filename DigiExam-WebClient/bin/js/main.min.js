...
$window.console.log("Lockdown onLockdown"), $window.console.log(nativeModule.onLockdown());
}, tearDown = function() {
...
return DXLockdown.executeLockdown(), DXLockdown.onLockdown(), $location.path(Urls.get("exam", {
id:exam.id,
