(function() {
var client;
client = angular.module("digiexamclient", [ "ngRoute", "ngAnimate", "digiexamclient.platform", "digiexamclient.user", "digiexamclient.storage", "digiexamclient.session", "digiexamclient.exam", "digiexamclient.validation", "digiexamclient.jsobjcbridge", "dx.webui.blockEditor", "dx.webui.scroll", "dx.webui.sticky", "dx.webui.grading", "angular-minimodal" ]), 
...
}.call(this), angular.module("digiexamclient.platform").config(function($provide) {
"use strict";
var SYSTEMS = [ {
name:"ELECTRON_APP",
isCurrentSystem:function() {
return /Electron/i.test(window.navigator.userAgent) ? !0 :void 0;
}
}, {
name:"CHROME_APP",
isCurrentSystem:function() {
...
"use strict";
}), angular.module("digiexamclient.storage").factory("ExamStorage", function() {
"use strict";
...
}.call(this), angular.module("digiexamclient.storage.localstorage").factory("BrowserLocalStorage", function($q, $window) {
"use strict";
...
}.call(this), angular.module("digiexamclient.storage.localstorage").factory("IOSLocalStorage", function($q, $timeout, $rootScope, JsObjcBridge) {
"use strict";
var COMMAND = {
...
}), angular.module("digiexamclient.storage.localstorage").service("DXLocalStorage", function(BrowserLocalStorage, ChromeAppLocalStorage, IOSLocalStorage, DX_PLATFORM) {
"use strict";
...
}), angular.module("digiexamclient.storage.filesystem").factory("BrowserFileSystem", function($q, $timeout) {
"use strict";
...
}.call(this), angular.module("digiexamclient.storage.filesystem").factory("ElectronFileSystem", function($q, $timeout) {
"use strict";
var mockedPromise = function(resolveData) {
var deferred = $q.defer();
return $timeout(function() {
...
angular.module("digiexamclient").controller("ExamController", function($rootScope, $scope, $routeParams, $location, $modal, $interval, $q, $filter, $http, Urls, Answer, AnswerQueue, AnswerState, ExamInfo, ExamInfoRepository, SessionService, DXLocalStorage, DXFileSystem, JsObjcBridge, QuestionType, DX_PLATFORM, GradingTypeEnum) {
...
return "IOS_WEBVIEW" !== DX_PLATFORM ? $scope.showOfflineFileTurnInDialog() :$scope.showUploadLaterDialog();
});
...
var promise;
return $scope.openOfflineFileError = "", promise = DXFileSystem.openFile([ {
extensions:[ "dxe" ]
