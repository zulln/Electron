...
}), angular.module("digiexamclient.lockdown", []).factory("ElectronLockdown", function($q, $window) {
"use strict";
var modulePath = "./platforms/electron/node/build/Release/dxlockdown", nativeModule = $window.require(modulePath), prepareLockdown = function() {
...
$window.console.log("Lockdown onLockdown"), nativeModule.onLockdown();
}, tearDown = function() {
...
}.call(this), angular.module("digiexamclient.preconditiontest", []).factory("ElectronPreconditionTest", function($q, $window, $http, DXFileSystem) {
"use strict";
...
internetAccessTest(onTestDone), writePermissionTest();
};
return {
init:init
};
...
}), angular.module("digiexamclient.storage.filesystem").factory("BrowserFileSystem", function($window, $q, $timeout) {
"use strict";
...
return DXLockdown.executeLockdown(), $location.path(Urls.get("exam", {
id:exam.id,
