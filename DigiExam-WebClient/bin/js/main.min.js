...
}.call(this), angular.module("digiexamclient.jsobjcbridge").factory("JsObjcBridge", function(DX_PLATFORM) {
"use strict";
...
}(), examDir = null, logDir = null, fs = $window.require("fs"), ipc = $window.require("ipc"), path = $window.require("path"), remote = $window.require("remote"), mockedPromise = ($window.require("./platforms/electron/node/build/Release/dxsavedialog"), 
remote.require("browser-window"), function(resolveData) {
var deferred = $q.defer();
return $timeout(function() {
deferred.resolve(resolveData);
}, 0), deferred.promise;
...
var fsQuotaPromise, ipc, queue, storageAnswersKey, storageExamKey;
return ipc = require("ipc"), $scope.QuestionType = QuestionType, $scope.GradingTypeEnum = GradingTypeEnum, 
...
}, ipc.sendSync("teardownLockdown")), modalInstance.result.then(function() {
return $scope.handleSuccessfulTurnIn();
}), modalInstance;
